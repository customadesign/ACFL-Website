      ...
      <div className="grid md:grid-cols-5 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li><Link href="/clients/search-coaches" className="hover:text-white transition-colors">Find a Coach</Link></li>
            <li><Link href="/group-coaching" className="hover:text-white transition-colors">Group Coaching</Link></li>
            <li><Link href="/corporate" className="hover:text-white transition-colors">Corporate Programs</Link></li>
