...
export const findMatches = async (req: Request, res: Response) => {
  ...
  const matches = [
    // Excellent Matches (90%+)
    {
      ...
      location: ["CA", "NY"],
      demographics: { gender: "Male", ethnicity: "Asian American, Taiwanese", religious_background: "None" },
      availability: 2,
      matchScore: 95,
      languages: ["English"],
    ...
    },
    {
      ...
      location: ["CA"],
      demographics: { gender: "Female", ethnicity: "Chinese Canadian", religious_background: "Buddhist" },
      availability: 10,
      matchScore: 94,
    ...
    },
    {
      ...
      location: ["TX", "FL"],
      demographics: { gender: "Female", ethnicity: "Hispanic", religious_background: "Catholic" },
      availability: 5,
      matchScore: 93,
    ...
    },
    {
      ...
      location: ["NY", "NJ"],
      demographics: { gender: "Male", ethnicity: "White", religious_background: "Christian" },
      availability: 8,
      matchScore: 92,
      languages: ["English"],
    ...
    },
    {
      ...
      location: ["GA", "SC"],
      demographics: { gender: "Female", ethnicity: "Black", religious_background: "Baptist" },
      availability: 6,
      matchScore: 91,
      languages: ["English"],
    ...
    },
    {
      ...
      location: ["WA", "OR"],
      demographics: { gender: "Female", ethnicity: "Korean American", religious_background: "None" },
      availability: 4,
      matchScore: 90,
