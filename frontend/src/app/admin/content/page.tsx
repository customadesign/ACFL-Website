...
export default function ContentManagement() {
  ...
  return (
    <div className="w-full">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            {pageContent && (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 text-sm sm:text-base rounded-lg transition-colors min-h-[44px] font-medium ${
      ...
      {/* Page Selector */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-3 sm:p-4 md:p-6 mb-6">
        <h2 className="text-lg sm:text-xl font-semibold text-gray-900 dark:text-white mb-3 sm:mb-4">Select Page to Edit</h2>
          ...
          {Object.entries(PAGE_TEMPLATES).map(([key, template]) => {
            ...
            return (
              <button
                ...
                className={`p-3 sm:p-4 rounded-lg border transition-colors min-h-[80px] sm:min-h-[100px] flex flex-col items-center justify-center ${
                  selectedPage === key
              ...
              >
                <IconComponent className={`w-5 h-5 sm:w-6 sm:h-6 mx-auto mb-1.5 sm:mb-2 ${
                  selectedPage === key ? 'text-blue-600 dark:text-blue-400' : 'text-gray-500 dark:text-gray-400'
                }`} />
                <p className={`text-xs sm:text-sm font-medium text-center ${
                  selectedPage === key ? 'text-blue-600 dark:text-blue-400' : 'text-gray-900 dark:text-white'
                }`}>
                  {template.name}
                </p>
              </button>
            ...
            return (
              ...
              >
                <div className="p-3 sm:p-4 md:p-6">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 pb-2 border-b border-gray-200 dark:border-gray-600 gap-3">
                    ...
                    <div className="flex gap-2 w-full sm:w-auto">
                      {!isEditing ? (
                        <button
                          ...
                          className="inline-flex items-center justify-center px-3 sm:px-4 py-2.5 border border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 rounded-md hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors text-sm sm:text-base font-medium min-h-[44px] w-full sm:w-auto"
                        >
                        ...
                        <>
                          <button
                            ...
                            disabled={saving}
                            className="inline-flex items-center justify-center px-3 sm:px-4 py-2.5 bg-green-600 dark:bg-green-700 text-white rounded-md hover:bg-green-700 dark:hover:bg-green-600 transition-colors text-sm sm:text-base font-medium disabled:opacity-50 min-h-[44px] flex-1 sm:flex-initial"
                          >
                          ...
                          <button
                            ...
                            className="inline-flex items-center justify-center px-3 sm:px-4 py-2.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-sm sm:text-base font-medium min-h-[44px] flex-1 sm:flex-initial"
                          >
                  ...
                  {isEditing ? (
                    <div className="space-y-4 sm:space-y-6">
                      {section.fields.map((field) => (
                        <div key={field.name} className="pb-2">
                          <label className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 mt-1">
                            {field.label}
                          </label>
                    ...
                    <div>
                      {section.fields.length > 0 && (
                        <div className="mb-4 p-2.5 sm:p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                          <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 flex items-center">
                            ...
                            <span className="sm:hidden">View mode - Click Edit to modify</span>
                          </p>
                        </div>
                      )}
                      <div className="space-y-4 sm:space-y-6">
                        {section.fields.map((field) => (
                          <div key={field.name} className="pb-2">
                            <label className="block text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400 mb-1 mt-1">
                              {field.label}
                            </label>
