...
interface SquareImmediatePaymentFormProps {
  amount: number;
  coachName: string;
  sessionTitle: string;
  bookingRequestId?: string; // For booking flow
  coachId?: string; // For direct booking
  coachRateId?: string; // For direct booking
  sessionDate?: string;
  sessionTime?: string;
  description?: string;
...
const SquareImmediatePaymentForm: React.FC<SquareImmediatePaymentFormProps> = ({
  amount,
  coachName,
  sessionTitle,
  bookingRequestId,
...
export default SquareImmediatePaymentForm;